...
<div class="Header">
    <div class="topbox">
        <a href="${ctx}/views/index.jsp" class="logo"><img src="${ctx}/static/images/201505091742494249.jpg"></a>
        <!--a href='' class="top-a"></a-->
        <div class="mainnav">
            <ul>
            <li><span><a href="${ctx}/views/index.jsp" id="mainnav1" class="aon">首页</a></span></li>
